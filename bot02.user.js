// ==UserScript==
// @name         Olympus Essentials - bot02
// @namespace    oess
// @author       pmpm2000
// @description  Auto-invite to alliance
// @version      0.0.1
// @downloadURL  https://github.com/pmpm2000/olympus_essentials/blob/main/bot02.user.js
// @updateURL    https://github.com/pmpm2000/olympus_essentials/blob/main/bot02.user.js
...
// ============================
    const account = "bot02"; // unique id of the bot's acc - no impact on the code
    const threadId = 3237; // ID of thread that the bot should subscribe
    const townId = 13552; // ID of the bot's town - it needs to own it all the time
// ============================
